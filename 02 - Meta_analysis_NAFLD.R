...
# La méta-analyse aura des mélanges de positions entre le build37 et le build38 (ceux uniques à FinnGen). 
# Ne pas l'utiliser (à moins de corriger les positions).
...
# Le "duplicated" de la ligne 170 va garder la première instance des SNPs communs aux 4 GWAS. Donc, la
# position gardée sera celle de UKB, qui est sur le build37. On n'aura pas de mélanges de positions 
# entre le build37 et le build38.
