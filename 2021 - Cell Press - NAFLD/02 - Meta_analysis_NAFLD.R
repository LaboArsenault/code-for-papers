...
word2 = "head"
args2 = c("-1",paste0("New_Results/",trait,"_1_new.txt > New_Results/meta_clean_",trait,".txt"))
word3 = "tail"
args3 = c("-n +2 -q",paste0("New_Results/",trait,"*_new.txt >> New_Results/meta_clean_",trait,".txt"))
system2(word2,args2)
system2(word3,args3)
